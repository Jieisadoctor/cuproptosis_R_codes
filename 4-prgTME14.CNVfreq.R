...
setwd("C:\\Users\\86188\\Desktop\\LUAD-Cu\\4.CNVfreq")      #设置工作目录
...
dataOUT=cbind(Gene=rownames(data),data)
write.table(dataOUT,file = "CNVresult.txt",sep = '\t',row.names = F,quote = F)

...
#biocLite("pRRophetic")
install.packages("pRRophetic_0.5.tar.gz", repos = NULL, dependencies = TRUE, type = "win.binary")
install.packages(c("car", "ridge", "preprocessCore", "genefilter", "sva"),force = TRUE)

options(pkgType="binary")

install.packages("D:/software/Rdata/pRRophetic_0.5.tar.gz", repos = NULL, type = "source")
...
setwd("D:\\software\\Rdata\\37.pRRophetic")     #设置工作目录

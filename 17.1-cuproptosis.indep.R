...
setwd("C:\\Users\\86188\\Desktop\\LUAD-Cu\\17.1.Cox")      #设置工作目录
...
#调用函数,进行独立预后分析
indep(riskFile="risk.train.txt", cliFile="clinical.txt", project="train")
indep(riskFile="risk.test.txt", cliFile="clinical.txt", project="test")

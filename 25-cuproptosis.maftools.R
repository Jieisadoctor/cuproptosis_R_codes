...
setwd("C:\\Users\\86188\\Desktop\\LUAD-Cu\\25.maftools")      #设置工作目录
...
oncoplot(maf=maf_high, genes=gene, colors = vc_cols, keepGeneOrder=T)
...
oncoplot(maf=maf_low, genes=gene, colors = vc_cols, keepGeneOrder=T)
dev.off()

#高低风险比较
HLrisk <- mafCompare(m1 = maf_high, m2 = maf_low, m1Name = 'High risk', m2Name = 'Low risk', minMut = 5)
pdf(file="forest.pdf", width=9, height=6)
forestPlot(mafCompareRes = HLrisk, pVal = 0.001,lineWidth = 2, color = c('#336699', '#996699'), geneFontSize = 0.8)
dev.off()

# #棒棒图
# primary.apl = system.file("extdata", "high.maf", package = "maftools")
# primary.apl = read.maf(maf = "high.maf")
# relapse.apl = system.file("extdata", "APL_relapse.maf.gz", package = "maftools")
# relapse.apl = read.maf(maf = relapse.apl)
# lollipopPlot2(m1 = primary.apl, m2 = relapse.apl, gene = "PML", AACol1 = "amino_acid_change", AACol2 = "amino_acid_change", m1_name = "Primary", m2_name = "Relapse")
# pdf(file="lollipopPlot2.pdf", width=9, height=6)
# lollipopPlot2(m1 = maf_high, m2 = maf_low, gene = "TTN", AACol1 =  'Protein_Change', AACol2 =  'Protein_Change', m1_name = "High risk", m2_name = "Low risk")
# dev.off()
